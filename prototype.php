      ...
      <div class="tab-pane container fade" id="allocate">
        ...
        <div class="row p-2">
          <div class="col-lg-3 col-md-3 col-sm-3 col-3">
            <button type="button" class="btn btn-info btn-block btn-block">1</button>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-3 col-3">
            <button type="button" class="btn btn-info btn-block btn-block">14</button>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-3 col-3">
            <button type="button" class="btn btn-info btn-block btn-block">15</button>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-3 col-3"></div>
        </div>
        <div class="row p-2">
          <div class="col-lg-3 col-md-3 col-sm-3 col-3">
            <button type="button" class="btn btn-info btn-block btn-block">2</button>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-3 col-3">
            <button type="button" class="btn btn-info btn-block btn-block">13</button>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-3 col-3">
            <button type="button" class="btn btn-info btn-block btn-block">16</button>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-3 col-3"></div>
        </div>
        <div class="row p-2">
